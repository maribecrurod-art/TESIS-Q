...
\pandocbounded{\includegraphics[keepaspectratio]{Imagenes_tesis/img_flor_1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Imagenes_tesis/img_flor_2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Imagenes_tesis/imagen_provicional.png}}
...
!{[}Los distintos filtros convolucionales permiten detectar
características específicas en la imagen de entrada. A continuación, se
muestran ejemplos representativos del efecto de diferentes kernels sobre
una misma imagen.

{]}(Imagenes\_tesis/img\_ejemplos\_filtros.png)\{fig-align=``center''\}
