...
](Imagenes_tesis/img_ejemplos_filtros.png){fig-align="center"}
...
Algunas de las funciones de activación más utilizadas son las siguientes: ![ReLU es eficientemente y se usa ampliamente en redes profundas.
Sigmoide es útil en la capa de salida para clasificación binaria.
Tanh es útil cuando se necesita una salida centrada en 0.
Leaky ReLu evita el problema de "neuronas muertas" de ReLu.](Imagenes_tesis/img_funciones_activacion.png){#fig-activaciones fig-align="center" width="82%"}
